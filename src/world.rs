...
// This file is generated by /build.rs and contains both NUM_GRID_ROWS and
// NUM_GRID_COLS constants, as well as a type like:
//   pub type Grid2DWorld00 = [[Tile; 23]; 17];
// These 'magic numbers' are the values of the constants. The information is
// redundant but having both type and consts defined was handy for a start.
...
// Function to load world data from a (temp. hardcoded) file to grid
fn load_world(grid: &mut Grid2DWorld00) {
    ...
    // Fill the grid with Tiles according to characters from the open file
    // TODO: move/centralize this char <-> TileKind mapping somewhere else
